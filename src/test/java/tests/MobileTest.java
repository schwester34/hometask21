    ...
    public class MobileTest extends TestBase {
        ...
        void searchTest() {
            ...
            step("Type search", () -> {
                ...
                $(AppiumBy.accessibilityId("Search text")).sendKeys("tchaikovsky");
                //$(AppiumBy.id("org.wikipedia.alpha:id/search_src_text")).sendKeys("tchaikovsky");
            });
            step("Verify content found", () ->
                    $$(AppiumBy.accessibilityId("Search page list item title"))
...
//findElement(By.className("Search Wikipedia"));